    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            try {
                ...
                Log.e(TAG,"Could not createSocket",e);
            }
            mmSocket = tmp;
        }
        ...
        public void run() {
            ...
            try {
                ...
                try {
                    mmSocket.close();
                } catch (IOException e2) {Log.e(TAG,"Could not close socket",e2); }
                connectionFailed();
                return;
            }
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket, String socketType) {
            ...
            try {
                ...
                Log.e(TAG,"Could not get one of the streams",e);
            }
            ...
            while (true) {
                try {
                    ...
                    if (count == 262) {
                        ...
                        Log.e(TAG,"Received data: "+ toHexString(buffer));
        ...
        public void write(byte[] buffer) {
            try {
                ...
                Log.d(TAG,"Could not write message to output stream",e);
            }
        }
